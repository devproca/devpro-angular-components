...
@Component({
  selector: `i-${TAG}`,
     template: `<svg focusable="false" data-icon="menu" class="svg-inline&#45;&#45;fa fa-times fa-w-10"
     height="384pt" width="384pt" xmlns="http://www.w3.org/2000/svg" viewBox="0 -53 384 384">
...
export class MenuIconComponent extends BaseSvgComponent {
     static tag = TAG;
}
