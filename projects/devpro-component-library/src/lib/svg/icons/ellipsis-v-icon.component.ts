...
const TAG = "ellipsis-v";

@Component({
  selector: `i-${TAG}`,
     template: `<svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="ellipsis-v"
     class="svg-inline--fa fa-ellipsis-v fa-w-4" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 512">
...
export class EllipsisVIconComponent extends BaseSvgComponent {
     static tag = TAG;
 }
