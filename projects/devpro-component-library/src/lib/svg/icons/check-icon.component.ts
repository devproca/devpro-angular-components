...
@Component({
  selector: `i-${TAG}`,
     template: `<svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="check" class="svg-inline--fa fa-check fa-w-16"
...
export class CheckIconComponent extends BaseSvgComponent {
      static tag = TAG;
}
